runTest(function()
	...
	assert(solo.DepthPassFunction_LEqual ~= nil)
	assert(solo.DepthPassFunction_Greater ~= nil)
	assert(solo.DepthPassFunction_NotEqual ~= nil)
	assert(solo.DepthPassFunction_GEqual ~= nil)
	assert(solo.DepthPassFunction_Always ~= nil)
end, "Enums")
