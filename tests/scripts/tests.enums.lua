runTest(function()
	...
	assert(solo.MeshPrimitiveType.Lines ~= nil)
	assert(solo.MeshPrimitiveType.LineStrip ~= nil)
	assert(solo.MeshPrimitiveType.Points ~= nil)
	assert(solo.MeshPrimitiveType.TriangleStrip ~= nil)
	assert(solo.MeshPrimitiveType.Triangles ~= nil)

	assert(solo.MeshIndexFormat.UnsignedByte ~= nil)
	assert(solo.MeshIndexFormat.UnsignedShort ~= nil)
	assert(solo.MeshIndexFormat.UnsignedInt ~= nil)

	assert(solo.VertexFormatElementSemantics.Position ~= nil)
	assert(solo.VertexFormatElementSemantics.Normal ~= nil)
	assert(solo.VertexFormatElementSemantics.Color ~= nil)
	assert(solo.VertexFormatElementSemantics.Tangent ~= nil)
	assert(solo.VertexFormatElementSemantics.Binormal ~= nil)
	assert(solo.VertexFormatElementSemantics.TexCoord0 ~= nil)
	assert(solo.VertexFormatElementSemantics.TexCoord1 ~= nil)
	assert(solo.VertexFormatElementSemantics.TexCoord2 ~= nil)
	assert(solo.VertexFormatElementSemantics.TexCoord3 ~= nil)
	assert(solo.VertexFormatElementSemantics.TexCoord4 ~= nil)
