...
function createPostProcessor1(device, camera, tag, effects)
    ...
    fbTex1:setData(solo.ImageFormat.RGB, {}, canvasSize.x, canvasSize.y)
    ...
    fbTex2:setData(solo.ImageFormat.RGB, {}, canvasSize.x, canvasSize.y)
...
function createPostProcessor2(device, camera, tag, effects)
    ...
    fbTex:setData(solo.ImageFormat.RGB, {}, offscreenRes.x, offscreenRes.y)
