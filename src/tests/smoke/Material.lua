...
mat:setVector2Parameter("p3", sl.Vector2.new(1, 2))
mat:setVector3Parameter("p5", sl.Vector3.new(1, 2, 3))
mat:setVector4Parameter("p7", sl.Vector4.new(1, 2, 3, 4))
mat:setMatrixParameter("p9", sl.Matrix.new())
