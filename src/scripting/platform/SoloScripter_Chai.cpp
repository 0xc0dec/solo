...
void Scripter_Chai::registerScriptApi()
{
	...
	engine->add(fun(static_cast<void(Vector4::*)(const Vector4&, const Vector4&)>(&Vector4::clamp)), "clamp");
	engine->add(fun(static_cast<void(*)(const Vector4&, const Vector4&, const Vector4&, Vector4*)>(&Vector4::clamp)), "clamp");
	engine->add(fun(&Vector4::distance), "distance");
	engine->add(fun(&Vector4::distanceSquared), "distanceSquared");
	engine->add(fun(static_cast<float(Vector4::*)(const Vector4&)const>(&Vector4::dot)), "dot");
	engine->add(fun(static_cast<float(*)(const Vector4&, const Vector4&)>(&Vector4::dot)), "dot");
	...
	engine->add(fun(static_cast<void(*)(const Quaternion&, const Quaternion&, float, Quaternion*)>(&Quaternion::lerp)), "lerp");
	engine->add(fun(static_cast<void(*)(const Quaternion&, const Quaternion&, float, Quaternion*)>(&Quaternion::slerp)), "slerp");
	engine->add(fun(static_cast<void(*)(const Quaternion&, const Quaternion&, const Quaternion&, const Quaternion&, float, Quaternion*)>(&Quaternion::squad)), "squad");
	engine->add(fun(static_cast<bool(Quaternion::*)()>(&Quaternion::inverse)), "inverse");
	engine->add(fun(static_cast<void(Quaternion::*)(const Quaternion&)>(&Quaternion::multiply)), "multiply");
	engine->add(fun(static_cast<void(*)(const Quaternion&, const Quaternion&, Quaternion*)>(&Quaternion::multiply)), "multiply");
