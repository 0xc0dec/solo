...
namespace solo
{
	...
	private:
		...
		static GLuint buildArrayBuffer(const std::vector<TElement>& elements, GLuint elementSize, GLuint index, GLenum elementType);
		static GLuint buildElementArrayBuffer(const std::vector<unsigned short>& elements);
