...
namespace solo
{
    ...
    public:
        ...
        virtual IndexBufferHandle createIndexBuffer(const void* data, int elementSize,
            int elementCount) override final { return EmptyIndexBufferHandle; }
        ...
        virtual UniformHandle createUniform(const char* name, UniformType type,
            int componentCount, ProgramHandle program) override final { return EmptyUniformHandle; }
